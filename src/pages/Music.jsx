...
import './Music.css'; // 새로운 CSS 파일을 불러옵니다.

// 노래 목록 (멜론차트 TOP 20 및 최신 유튜브 링크로 업데이트)
const SONGS = [
  ...
  { name: "나는 아픈 건 딱 질색이니까", artist: "(여자)아이들", youtube: "https://www.youtube.com/watch?v=ATK7gAaZTOM" },
  { name: "고민중독", artist: "QWER", youtube: "https://www.youtube.com/watch?v=ImuWa3SJulY" },
...
      <p className="subtitle">최근 즐겨듣는 노래 리스트</p>
